...
export default function Home() {
  ...
  return (
    <main ref={mainRef} className="relative w-full overflow-x-hidden" style={{ visibility: "hidden", opacity: 0 }}>
      {/* Floating Nav */}
      <div className="fixed top-4 right-4 flex items-center gap-4 bg-gray-200 px-4 py-2 rounded-full shadow-lg z-50">
        ...
        <button className="px-4 py-2 bg-gray-900 text-gray-100 rounded-lg hover:bg-gray-800 transition">Sign Up</button>
      </div>
      ...
      <div ref={pinnedSectionRef} className="relative h-screen z-10 overflow-hidden">
        ...
        <div ref={slide1Ref} className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center px-4 perspective-[1000px] z-20">
          ...
          {/* Hero Button */}
          <button onClick={scrollToForm} className="mt-10 px-8 py-4 rounded transition-all duration-300 text-gray-100 bg-gradient-to-r from-gray-900 to-gray-700 shadow-md hover:shadow-xl hover:shadow-gray-500/50 hover:from-gray-800 hover:to-gray-600 focus:outline-none z-30">
            Get Early Access
          </button>
        </div>
      ...
      <div ref={sectionInsertedRef} className="flex items-center h-screen text-gray-900 px-6 md:px-12">
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h2 className="text-4xl font-bold tracking-tight leading-tight md:max-w-2xl">
              A proven system designed to help teams move faster, engage smarter, and drive greater trust.
            </h2>
          </div>
          <ul className="text-xl text-gray-700 font-medium leading-relaxed space-y-3">
        ...
        <div ref={formContentRef} className="max-w-xl mx-auto">
          <div className="backdrop-blur rounded-2xl shadow-xl p-8 border border-gray-300">
            ...
            <form className="space-y-6">
              ...
              <button type="submit" className="w-full bg-gray-900 text-gray-100 font-semibold py-2 px-4 rounded hover:bg-gray-800">
